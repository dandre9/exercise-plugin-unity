...
public static class ExerciseService
{
    ...
    {
        string[] coordsString = fakeCoords;
        int numOfDirections = fakeCoords.Length;
        ...
        double[,] coordsArray = new double[numOfDirections, 2];
        ...
        for (int i = 0; i < numOfDirections; i++)
        {
            ...
            Debug.Log(coordsArray[i, 0] + " - " + coordsArray[i, 1]);
        }
